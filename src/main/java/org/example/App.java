...
public class App {
    ...
    public static void main( String[] args ) throws IOException, URISyntaxException{
        ...
        BagOfWords bagOfWords = BagOfWords.fit(train, s -> s.split(" "), 10, "V2");
...
//        Classifier<int[]> svm = SVM.fit(x, y, 1, 0.1, 0.01);

//        DataFrame result = test2vec.stream().skip(2)
//                .map(tuple -> {
//                    Tuple res = Tuple.of(new Object[]{tuple.get("id") , svm.predict((int[]) tuple.get("text_vec"))},
//                            new StructType(
//                                    new StructField("id", DataTypes.IntegerObjectType),
//                                    new StructField("sentiment", DataTypes.IntegerObjectType)));
//
